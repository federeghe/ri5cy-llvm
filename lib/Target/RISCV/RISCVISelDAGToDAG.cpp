...
class RISCVDAGToDAGISel : public SelectionDAGISel {
 ...
 bool SelectPCLIPU(SDValue Dest, SDValue &SRC1, SDValue &SRC2);
public:
...
bool RISCVDAGToDAGISel::SelectPCLIP(SDValue Dest, SDValue &SRC1, SDValue &SRC2) {
    return RI5CY_pclip_check(CurDAG, Dest, SRC1, SRC2, false);
}

bool RISCVDAGToDAGISel::SelectPCLIPU(SDValue Dest, SDValue &SRC1, SDValue &SRC2) {
    return RI5CY_pclip_check(CurDAG, Dest, SRC1, SRC2, true);
}
